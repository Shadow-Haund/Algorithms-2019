...
abstract class AbstractDynamicTests {
    fun longestCommonSubSequence(longestCommonSubSequence: (String, String) -> String) {
        ...
        //Мои тесты
        assertEquals("ку", longestCommonSubSequence("куча слов", "в топку"))
        assertEquals("1234567890", longestCommonSubSequence("1234567890987654321", "0987654321234567890"))
        //
...
Наследник всех своих родных.
    ...
    fun shortestPathOnField(shortestPathOnField: (String) -> Int) {
        ...
        //Мои тесты
        assertEquals(18, shortestPathOnField("input/field_in7.txt"))
